...
public:
    ...
    inline const glm::vec3& GetRot() const { return rotation; }
    inline const glm::vec3& GetScale() const { return scale; }

    inline void SetPos(const glm::vec3& position) { this->position = position; }
    inline void SetRot(const glm::vec3& rotation) { this->rotation = rotation; }
